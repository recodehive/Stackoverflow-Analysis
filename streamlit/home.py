...
full_data2018 = full_data2018.rename(columns={"Hobby": "Hobbyist", 
...
def plot_value_counts(column_name, ax):
    ...
    df_ai[column_name].value_counts().plot(kind='bar', color=random.choice(colors), ax=ax)
...
if year == '2018':
    ...
    <div style='margin-top: 400px !important' class='analysis-container'>
        ...
        <div class='analysis-text'>
            The top three countries which have a highest mean annual salary of a data scientist are South Korea (253,315) in 2018,Ireland (275,851) in 2019 and the USA(118,863) in 2020.Apart from that, the mean salary of the rest of the countries is less than (200,000) per year. Japan provides the highest mean annual salary among Asian countries (118,969)
            Figures in Dollars $
        </div>
    </div>
"""
    ...
    # with visual:
    #     st.title('Age of Respondents')
    #     ff.plot_age_distribution(df2018, 'Age')
